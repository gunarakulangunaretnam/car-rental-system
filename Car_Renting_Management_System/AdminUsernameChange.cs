...
{
    public partial class AdminUsernameChange : Form
    {
        public AdminUsernameChange()
        {
            InitializeComponent();
        }
        ...
        private void AdminUsernameChange_Load(object sender, EventArgs e)
        {
            string userName = "";
            string password = "";
        ...
        private void bunifuFlatButton5_Click(object sender, EventArgs e)
        {
            if (monoFlat_TextBox1.Text != string.Empty && monoFlat_TextBox2.Text != string.Empty)
            {
                if (monoFlat_TextBox1.Text == user)
                {
                    ...
                    string txt = "The Admin username was changed on " + DateTime.Now.ToString("yyyy-MM-dd") + " at " + DateTime.Now.ToLongTimeString();
        ...
        private void label4_MouseMove(object sender, MouseEventArgs e)
        {
            if (canMove == 1)
            {
                ...
                this.SetDesktopLocation(MousePosition.X - 310, MousePosition.Y - 17);
